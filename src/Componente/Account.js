...
import defaultAvatar from "../Assets/LOGO-280-x-280-px.png"
  ...
  return (
    <div>
      ...
      <div className='continutAccount'>
        ...
        <img src={userPhoto || defaultAvatar} alt='Profil' />
        <h2 style={{marginLeft:20}}>Hello, </h2>
        <h3 style={{marginLeft:20,alignSelf:'center'}}> {username}</h3>
        </div>
        ...
        style={{ color: 'red', background: 'transparent', fontSize: 15, fontWeight: 'bold', position: 'relative', bottom: 100 }}
      >
